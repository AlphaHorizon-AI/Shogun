...
TOOL_RISK_REGISTRY: dict[str, dict[str, str]] = {
    ...
    "transformation_profiles_validate": {"risk": "medium", "category": "transformation_profiles"},
    "transformation_profiles_promote":  {"risk": "high",   "category": "transformation_profiles"},
    "transformation_profiles_rollback": {"risk": "high",   "category": "transformation_profiles"},
