...
class StackRun(Base, UUIDMixin, AuditMixin):
    ...
    output_publication: Mapped[str] = mapped_column(String(30), nullable=False, default="summary_and_final")
    ...
    published_output: Mapped[dict] = mapped_column(JSONType(), nullable=False, default=dict)
